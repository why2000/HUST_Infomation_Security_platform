...
router.get('/semester', CourseController.getNowSemester)
router.get('/allsemester', CourseController.getAllSemester)
router.post('/setsemester', CourseController.changeSemesterTmp)
router.get('/createsemester', CourseController.createNewSemester)
