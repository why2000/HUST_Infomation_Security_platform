...
function AddFillAnswer(o) {
  ...
  console.log(current);
  $(o).parent().parent().parent().find('#options').append("<div class=\"input-group mb-3\"><div class=\"input-group-prepend\"></div> <input name=\"gaps" + current + "\" type=\"text\" class=\"form-control text-center\" id= \"gapcontent\" aria-label=\"Text input with checkbox\" placeholder=\"填空内容\"></div>");
}
